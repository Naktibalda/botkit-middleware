...
module.exports = function(config) {
  ...
  middleware.interpretAsync = Promise.promisify(middleware.interpret, {context: middleware});
  middleware.sendToWatsonAsync = Promise.promisify(middleware.sendToWatson, {context: middleware});
  middleware.readContextAsync = Promise.promisify(middleware.readContext, {context: middleware});
  middleware.updateContextAsync = Promise.promisify(middleware.updateContext, {context: middleware});
